      ...
      <GridContainer>
        ...
        >
          ...
          <h5 className={classes.description}>
            Our product is a voice assistant for coding that allows you to
            increase efficiency and productivity with almost no effort.
          </h5>
        </GridItem>
      </GridContainer>
      <GridContainer>
        <GridItem md={4} sm={4}>
          <InfoArea
            ...
            description={
              <span>
                <p>Just download and start asking questions </p>
